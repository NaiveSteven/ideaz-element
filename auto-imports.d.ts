...
declare global {
  ...
  import('vue')
  // @ts-ignore
  export type { Slots } from './packages/hooks/useFormComponentSlots'
  import('./packages/hooks/useFormComponentSlots')
  // @ts-ignore
  export type { TranslatePair, Language, TranslatorOption, Translator, LocaleContext } from './packages/hooks/useLocale'
  import('./packages/hooks/useLocale')
}
