...
<template>
  <div class="ivu-ellipsis">
    <slot name="prefix" class="ivu-ellipsis-prefix" />
    <template v-if="computedReady">
      <Tooltip v-if="tooltip" :content="text" :theme="theme" :max-width="maxWidth" :placement="placement"
        :transfer="transfer">
        <span ref="text" class="ivu-ellipsis-text">{{ text }}</span>
        <span v-show="oversize" ref="more" class="ivu-ellipsis-more">
          <slot name="more">...</slot>
        </span>
        <slot name="suffix" class="ivu-ellipsis-suffix" />
      </Tooltip>
      <template v-else>
        <span ref="text" class="ivu-ellipsis-text">{{ text }}</span>
        <span v-show="oversize" ref="more" class="ivu-ellipsis-more">
